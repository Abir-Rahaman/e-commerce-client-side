    ...
    <div className="bg-base-200  flex-col">
      <div class="hero pt-24 pb-6">
        <div class="hero-content flex-col lg:flex-row-reverse">
          <span className="text-6xl text-slate-800 mx-auto hidden lg:block rounded-full bg-gradient-to-r from-indigo-200 via-purple-100 to-pink-200 p-6 lg:relative lg:top-[-290px] lg:right-[260px] z-10">
