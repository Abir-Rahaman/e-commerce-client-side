  ...
  return (
    <div className="mx-auto ">
      ...
      <div class="card w-96 bg-gradient-to-r from-indigo-200 via-purple-100 to-pink-200 shadow-xl mb-12">
        ...
        <div class="card-body">
        <small className="font-bold">Hello, <span className="text-green-600">{user.displayName} </span></small>
          <h2 class="card-title">Please Pay for <span className="text-green-600">{order.name}</span></h2>
          <p className="font-bold">Your Payable Amount : <span className="text-green-600"><FormatPrice price={order.price}></FormatPrice></span></p>
